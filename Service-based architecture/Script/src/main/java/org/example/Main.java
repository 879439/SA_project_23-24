...
public class Main {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        waitForService("http://UserService:8080/api/auth/hello");
        ...
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("http://UserService:8080/api/auth/signup"))
        ...
        request = HttpRequest.newBuilder()
                .uri(URI.create("http://UserService:8080/api/auth/signin"))
                .header("Content-Type", "application/json")
                .POST(HttpRequest.BodyPublishers.ofString(json2))
                .build();
        ...
        System.out.println("Status Code: " + response.statusCode());
        System.out.println("Response: " + response.body());
        String url = "http://FlightService:8081/api/flights";
